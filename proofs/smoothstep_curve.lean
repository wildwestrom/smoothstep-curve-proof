/-
This spiral uses a smoothstep-based curvature function, providing a $G^\infty$ continuous transition from tangent to circular arc.
...
My goal is to prove my curvature function is $C^\infty$ continuous.
-/
